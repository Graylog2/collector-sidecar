...
import (
	...
	_ "github.com/Graylog2/collector-sidecar/extension/sidecar/daemon"
)
...
//	serviceConfig := &service.ExtensionConfig{
...
func commandLineSetup() error {
	...
	if *printVersion {
		fmt.Printf("Graylog Collector Config version %s%s (%s) [%s/%s]\n",
